...
class FraudDetectionModel:
    ...
    def __init__(self, processed_data_path, target_column):
    ...
    def balance_data(self, target_col='class'):
        ...
        self.data = pd.DataFrame(X_balanced)
        self.data[target_col] = y_balanced

        # Save the balanced data
        output_path = '/home/am/Documents/Software Development/10_Academy Training/\
        week_8-9/fraud-detection/data/balanced_data.csv'
        self.data.to_csv(output_path, index=False)

        print("Data balancing completed successfully.")
        print(
            f"Balanced and processed data saved successfully as {output_path}")
    ...
    def data_preparation(self, test_size=0.2):
        ...
        print("Data prepared for training: Train and test sets created.")
    ...
    def train_deep_learning_models(
        ...
        # Save the loss plot
        loss_plot_path = f"/home/am/Documents/Software Development/10_Academy Training/\
            week_8-9/fraud-detection/notebooks/plots/{model_type}_training_loss.png"
    ...
    def save_model(self, model_name):
        """Save the model given as an attribute.
        """
        ...
        if model_name in ['CNN', 'RNN', 'LSTM']:
            torch.save(model.state_dict(), f"/home/am/Documents/Software Development/\
                       10_Academy Training/week_8-9/\
                       fraud-detection/models/{model_name}.pth")
        else:

            # Open the file in write binary mode ('wb')
            with open(f"/home/am/Documents/Software Development/10_Academy Training/week_8-9/\
                      fraud-detection/models/{model_name}.pkl", 'wb') as f:

                # Pass the file object 'f' to pickle.dump
                pickle.dump(model, f)
